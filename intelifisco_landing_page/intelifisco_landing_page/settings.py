"""
Django settings for intelifisco_landing_page project.
...
ALLOWED_HOSTS = ['127.0.0.1', '.vercel.app', 'intelifisco.com.br', 'www.intelifisco.com.br']
...
ROOT_URLCONF = 'intelifisco_landing_page.urls'
...
WSGI_APPLICATION = 'intelifisco_landing_page.wsgi.application'
...
LOCALE_PATHS = [
    BASE_DIR / 'locale',  # onde ficarão os arquivos de tradução
]
